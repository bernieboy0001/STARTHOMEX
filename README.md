...
- in-app install prompt where supported
- offline emergency snapshot cached on the device after opening the dashboard
...
- Emergency profile card with offline snapshot.
- Document vault via secure links.
- Care notes timeline.
- Family invite links and member management.
- Invite revocation and member removal for leads.
...
- Offline data sync beyond the emergency snapshot.
- Camera document scanning.
- Voice notes.
- Native app wrapper for app stores.
- AI summaries, discharge-paper extraction, and smart reminders.
...
- Installable PWA shell with offline fallback page and emergency snapshot.
